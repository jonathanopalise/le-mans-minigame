...
CFLAGS = -nostdlib -D__ATARI__ -D__M68000__ -D__NATFEATS_DEBUG -DELF_CONFIG_STACK=1024 -flto -fleading-underscore -Os -fomit-frame-pointer -m68000 -Wall
VASM = vasmm68k_mot
VASM_OPTS =
VLINK = vlink
PHP = php
...
src/hardware_playfield.o: src/hardware_playfield.c src/hardware_playfield.h src/blitter.h src/draw_sprite.h src/draw_status.h src/status_definitions.h src/bitplane_draw_record.h src/natfeats.h src/initialise.h src/hud.h src/hud_digits.h src/lookups.h src/player_car.h
