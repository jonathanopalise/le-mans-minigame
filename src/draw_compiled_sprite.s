...
_draw_compiled_sprite:
    ...
    move.l a2,$ffff8a32.w ; set destination address
    move.w #$4,$ffff8a38.w ; set ycount (4 bitplanes)
    move.w #$8000,$ffff8a28.w ; set endmask1
    move.w #$3fff,$ffff8a2c.w ; set endmask3
    move.w #$c080,$ffff8a3c.w ; set blitter control
    ...
    move.l a2,$ffff8a32.w ; set destination address
    move.w #$4,$ffff8a38.w ; set ycount (4 bitplanes)
    move.w #$fffe,$ffff8a28.w ; set endmask1
    move.w #$0,$ffff8a2a.w ; set endmask2 (might be able to merge this and following call)
    move.w #$fff,$ffff8a2c.w ; set endmask3
    move.w #$c080,$ffff8a3c.w ; set blitter control

    lea.l 480(a1),a2 ; calc destination address into a2
    move.l a2,$ffff8a32.w ; set destination address
    move.w #$4,$ffff8a38.w ; set ycount (4 bitplanes)
    move.w #$fffc,$ffff8a28.w ; set endmask1
    move.w #$0,$ffff8a2a.w ; set endmask2 (might be able to merge this and following call)
    move.w #$7ff,$ffff8a2c.w ; set endmask3
    move.w #$c080,$ffff8a3c.w ; set blitter control

    lea.l 640(a1),a2 ; calc destination address into a2
    move.l a2,$ffff8a32.w ; set destination address
    move.w #$4,$ffff8a38.w ; set ycount (4 bitplanes)
    move.w #$c000,$ffff8a28.w ; set endmask1
    move.w #$0,$ffff8a2a.w ; set endmask2 (might be able to merge this and following call)
    move.w #$f,$ffff8a2c.w ; set endmask3
    move.w #$c080,$ffff8a3c.w ; set blitter control
    ...
    move.w #$8000,$ffff8a28.w ; set endmask1
    move.w #$0,$ffff8a2a.w ; set endmask2 (might be able to merge this and following call)
    move.w #$3,$ffff8a2c.w ; set endmask3
    move.w #$c080,$ffff8a3c.w ; set blitter control

    lea.l 960(a1),a2 ; calc destination address into a2
    move.l a2,$ffff8a32.w ; set destination address
    move.w #$4,$ffff8a38.w ; set ycount (4 bitplanes)
    move.w #$0,$ffff8a28.w ; set endmask1
    move.w #$0,$ffff8a2a.w ; set endmask2 (might be able to merge this and following call)
    ...
    move.l a2,$ffff8a32.w ; set destination address
    move.w #$4,$ffff8a38.w ; set ycount (4 bitplanes)
    move.w #$ffe0,$ffff8a28.w ; set endmask1
    move.w #$0,$ffff8a2a.w ; set endmask2 (might be able to merge this and following call)
    move.w #$30,$ffff8a2c.w ; set endmask3
    move.w #$c080,$ffff8a3c.w ; set blitter control
    ...
    move.w #$4,$ffff8a38.w ; set ycount (4 bitplanes)
    move.w #$ffe0,$ffff8a28.w ; set endmask1
    move.w #$7f,$ffff8a2a.w ; set endmask2 (might be able to merge this and following call)
    ...
    move.l a2,$ffff8a32.w ; set destination address
    move.w #$4,$ffff8a38.w ; set ycount (4 bitplanes)
    move.w #$fff0,$ffff8a28.w ; set endmask1
    move.w #$ff,$ffff8a2a.w ; set endmask2 (might be able to merge this and following call)
    ...
    move.w #$0,$ffff8a28.w ; set endmask1
    move.w #$0,$ffff8a2a.w ; set endmask2 (might be able to merge this and following call)
    move.w #$0,$ffff8a2c.w ; set endmask3
    move.w #$c080,$ffff8a3c.w ; set blitter control
    ...
    move.l a2,$ffff8a32.w ; set destination address
    move.w #$4,$ffff8a38.w ; set ycount (4 bitplanes)
    move.w #$fc00,$ffff8a28.w ; set endmask1
    move.w #$0,$ffff8a2a.w ; set endmask2 (might be able to merge this and following call)
    ...
    move.l a2,$ffff8a32.w ; set destination address
    move.w #$4,$ffff8a38.w ; set ycount (4 bitplanes)
    move.w #$fe00,$ffff8a28.w ; set endmask1
    move.w #$0,$ffff8a2a.w ; set endmask2 (might be able to merge this and following call)
    move.w #$f,$ffff8a2c.w ; set endmask3
    move.w #$c080,$ffff8a3c.w ; set blitter control
    ...
    move.w #$0,$ffff8a2a.w ; set endmask2 (might be able to merge this and following call)
    move.w #$1f,$ffff8a2c.w ; set endmask3
    move.w #$c080,$ffff8a3c.w ; set blitter control

    lea.l 3360(a1),a2 ; calc destination address into a2
    move.l a2,$ffff8a32.w ; set destination address
    move.w #$4,$ffff8a38.w ; set ycount (4 bitplanes)
    move.w #$ff80,$ffff8a28.w ; set endmask1
    move.w #$0,$ffff8a2a.w ; set endmask2 (might be able to merge this and following call)
    move.w #$1f,$ffff8a2c.w ; set endmask3
    move.w #$c080,$ffff8a3c.w ; set blitter control
