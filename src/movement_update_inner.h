...
void movement_update_inner_scenario_3(
    uint16_t road_scanline_struct_size,
    uint16_t *logical_xpos_address,
    uint16_t *add_value_address_1,
    uint16_t *add_value_address_2
);

void movement_update_inner_scenario_4(
    uint16_t road_scanline_struct_size,
    uint16_t *logical_xpos_address,
    uint16_t *add_value_address_1,
    uint16_t *add_value_address_2
...
void movement_update_inner_scenario_5(
    uint16_t road_scanline_struct_size,
    uint16_t *logical_xpos_address,
    uint16_t *add_value_address_1,
    uint16_t *add_value_address_2
...
void movement_update_inner_scenario_6(
    uint16_t road_scanline_struct_size,
    uint16_t *logical_xpos_address,
    uint16_t *add_value_address_1,
    uint16_t *add_value_address_2
