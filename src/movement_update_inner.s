...
_movement_update_inner_scenario_1:
    ...
    move.l 8(a0),a1     ; &(current_road_scanline->current_logical_xpos)
    move.l 12(a0),d1    ; &(current_road_scanline->logical_xpos_add_values[shift_required]
    sub.l a1,d1

    rept 100
    move.l 0(a1,d1),d0     ; current_road_scanline->logical_xpos_add_values[shift_required]
    add.l d0,(a1)      ; current_logical_xpos+=(above value)
